...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "pander1234@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "1234567890");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "Tulip Road");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "London");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "A123BC");
