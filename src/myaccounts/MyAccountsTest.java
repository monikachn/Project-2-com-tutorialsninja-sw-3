...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        verifyFromElement(By.xpath("//h1[contains(text(),'MacBook')]"), "MacBook");
       ...
       // Thread.sleep(2000);
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Lina");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Pander");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "pander123@gmail.com");
        ...
        sendTextToElement(By.xpath("//select[@id='input-payment-country']"), "222");
        // sendTextToElement(By.name("input-payment-zone"),"Surrey");
       // Thread.sleep(2000);
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='input-payment-zone']"), "3513");
        // sendTextToElement(By.xpath("//select[@id='input-payment-zone']"), "3553");
       ...
       // 2.25 Verify the message “Warning: Payment method required!”
        verifyFromElement(By.xpath("//div[text()='Warning: Payment method required!']"), "Warning: Payment method required!\n" + "×");
    }
